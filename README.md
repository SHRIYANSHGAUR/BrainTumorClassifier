...
### Created a FLASK Backend to initialize the model and get the image from post request and converts it  -> img = base64_to_pil(request.json) to 
make predictions on server side and then the results are jasonified and sent to Frontend TEMPLATE for display.
